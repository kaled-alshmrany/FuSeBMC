...
#SF = Selective Fuzzer
FuSeBMCFuzzerLib_ERRORCALL_FUSEBMC_SF_STAGE_ITERATION = 4
...
FuSeBMCFuzzerLib_ERRORCALL_SELECTIVE_INPUTS_TIME_INCREMENT = 400 #seconds
...
#SF = Selective Fuzzer
FuSeBMCFuzzerLib_COVERBRANCHES_FUSEBMC_SF_STAGE_ITERATION = 4
...
FuSeBMCFuzzerLib_COVERBRANCHES_SELECTIVE_INPUTS_TIME_INCREMENT = 550 #seconds
