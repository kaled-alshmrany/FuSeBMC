...
"""
# strings
esbmc_path = "/home/kaled/Desktop/esbmc-v6.0/bin/esbmc "
...
def get_command_line(strat, prop, arch, benchmark, fp_mode):
	...
	#print('local witness_file_name',witness_file_name)
...
parser.add_argument("-eargs", "--esbmcargs" , help="Additional args to ESBMC")
...
esbmcargs=args.esbmcargs
esbmcargs = esbmcargs.replace('\"','')
esbmcargs = esbmcargs.replace('\'','')
esbmc_dargs += " " + esbmcargs + " "
...
if witnessfile is None:
	print ("Please, specify a witnessfile")
	exit(1)
